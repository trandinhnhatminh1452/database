...
<body>
    ...
    <?php
    get_form("database/TeamManage/Coaches/add.php","Add", ["Name","Club", "Nationality", "D.O.B", "Begin Date", "End Date"],["text","text","text","Date","Date","Date"],["Name","Club", "Nationality", "DOB", "Begin_Date", "End_Date"]);
    get_form("database/TeamManage/Coaches/delete.php","Delete", ["ID"],["number"],["ID"]);
    get_form("database/TeamManage/Coaches/update.php","Update", ["ID","Name","Club", "Nationality", "D.O.B", "Begin Date", "End Date"],["number","text","text","text","Date","Date","Date"],["ID","Name","Club", "Nationality", "DOB", "Begin_Date", "End_Date"]);
    ?>
