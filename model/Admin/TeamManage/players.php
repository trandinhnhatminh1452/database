...
<body>
    ...
    <?php
     get_form("database/Admin/TeamManage/Players/add_player.php","Add", ["Name","Club", "Shirt No", "Position","D.O.B","Begin Date","End Date"],["text","text","number","text","Date","Date","Date"],["Name","Club", "Shirt_No", "Position","DOB","Begin_Date","End_Date"]);
     get_form("database/Admin/TeamManage/Players/update_player.php","Update", ["ID","Name","Club", "Shirt No", "Position", "D.O.B", "Begin Date", "End Date"], ["number","text","text","number","text","Date","Date","Date"],["ID","Name","Club", "Shirt_No", "Position","DOB","Begin_Date","End_Date"]);
     get_form("database/Admin/TeamManage/Players/delete_player.php","Delete", ["ID"],["number"],["ID"]);
    ?>
